...
EXP_NAME="BAKE_AblationC_${T_MODEL_SAFE}_${O_MODEL_SAFE}_${DS_LABEL}_${SUB_LABEL}_${LIM_LABEL}_${MODE_LABEL}_${COUNT_LABEL}_${DATE_LABEL}"
...
# 建構指令
CMD="python run_ablation.py --output_dir $OUTPUT_DIR --task $TASK --limit $LIMIT --split $SPLIT"
if [ "$TASK" == "mmlu" ]; then
