...
# --- 定義 EXP_NAME (Ablation B) ---
EXP_NAME="BAKE_AblationB_${T_MODEL_SAFE}_${O_MODEL_SAFE}_${DS_LABEL}_${SUB_LABEL}_${LIM_LABEL}_${MODE_LABEL}_${COUNT_LABEL}_${SHUFFLE_LABEL}_${DATE_LABEL}"
